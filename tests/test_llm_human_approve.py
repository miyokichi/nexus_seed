"""AT4: a human approval of a REVIEW proposal resumes and applies it."""
...
async def test_human_approve_applies_proposal(tmp_path):
    ...
    # Human approves via a normal event.
    ...
    assert runtime.get_proposal(proposal.id).decision is ProposalDecision.ACCEPT

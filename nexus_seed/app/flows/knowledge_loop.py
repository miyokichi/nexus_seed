...
from ...modules.observer.adapters.manual import ManualAdapter
from ...modules.observer.sources import (
    FOLDER_STATUS_EVENT,
    SYSTEM_SNAPSHOT_EVENT,
    flatten_snapshot,
)
from ...modules.knowledge.bootstrap_context import ContextDocuments
from ...modules.knowledge.consolidation import Consolidator
...
from ...modules.knowledge.principles import PrincipleExtractor
from ...modules.knowledge.projection import WorldStateProjection, annotate_world_fact
from ...modules.planner.context_assessment import ContextAssessor
from ...modules.project_manager.models import A2AMessage, A2AMessageType
